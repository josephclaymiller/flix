...
<br>
In order to get the Flix to run on my iPhone which is on iOS 13.1, I had to lower the project's deployment target from 14.0. This was not an issue since the app is not using any features exclusive to iOS 14.0.
